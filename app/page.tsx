        ...
        <section className="relative overflow-hidden border-b">
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 py-24 sm:py-36 text-center">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
              Drag &amp; drop szerkesztő, valós idejű előnézet és PDF exportálás — minden, amire
              szükséged van az álomálláshoz.
            </p>
          ...
          <div className="mx-auto max-w-3xl px-4 sm:px-6 text-center">
            <div className="rounded-3xl border bg-card p-10 sm:p-14 shadow-sm">
              ...
              <p className="text-muted-foreground text-lg mb-8 max-w-md mx-auto">
                Hozd létre az önéletrajzodat még ma — teljesen ingyenesen, regisztráció után
                azonnal.
              </p>
              <Link href="/auth/register">
