 ...
 return (
  <div className="fixed bottom-0 left-0 right-0 z-50 p-4 sm:p-6">
   <div className="mx-auto max-w-3xl">
    {/* Mobilon oszlopos elrendezés: szöveg felül, gombok alul jobbra igazítva.
        sm+ képernyőn egy sorban marad minden elem. */}
    <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:gap-4 rounded-2xl border bg-card/95 backdrop-blur-sm shadow-lg px-5 py-4">
     ...
     <div className="flex items-start gap-3 flex-1 min-w-0">
      ...
      <div className="min-w-0">
       ...
       <p className="text-xs text-muted-foreground leading-relaxed">
        Ez az oldal kizárólag a bejelentkezéshez szükséges munkamenet-cookie-kat
        használ. Nyomkövetési vagy analitikai sütik nincsenek.{' '}
        <Link
         href="/adatvedelem"
     ...
     {/* Gombok — mobilon jobbra igazítva a szöveg alatt, sm+-on egy sorban */}
